	...
	public Permission_rscPermissions(Plugin plugin) {
		...
		if (rscp == null) {
			...
			if (perms != null && perms.isEnabled()) {
				...
				rscpAPI = rscp.API;
				plugin.getLogger().info(String.format("[%s][Permission] %s hooked.", plugin.getDescription().getName(),
						"rscPermissions"));
			}
		}
	}
		...
		public void onPluginEnable(PluginEnableEvent event) {
			if (bridge.rscp == null) {
				...
				if (plugin.getDescription().getName().equals("rscPermissions")) {
					...
					log.info(String.format("[%s][Permission] %s hooked.", vault.getDescription().getName(),
							"rscPermissions"));
				}
			}
		}

...
public class Items {
    ...
    static {
        ...
        items.add(new ItemInfo("Dead Shrub", new String[][]{{"shru"}}, Material.LONG_GRASS, (short) 0));
        ...
        items.add(new ItemInfo("Dead Bush", nnew String[][]{{"dead", "bush"}, {"dese", "bush"}}, Material.DEAD_BUSH));

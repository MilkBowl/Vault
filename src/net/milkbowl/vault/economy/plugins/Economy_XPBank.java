...
public class Economy_XPBank extends AbstractEconomy {
	...
	public EconomyResponse withdrawPlayer(String playerName, double amount) {
		...
		if (value > balance) {
			return new EconomyResponse(0, balance, ResponseType.FAILURE,
					String.format(api.getMsg("InsufficientXP"), api.currencyName(value)));
		}
	...
	public EconomyResponse depositPlayer(String playerName, double amount) {
		...
		if (account == null) {
			...
			// return new EconomyResponse(0, 0, ResponseType.FAILURE, "Player doesn't
			// exist");
	...
	public EconomyResponse createBank(String name, String player) {
		...
		if (groupBank != null) {
			return new EconomyResponse(0, groupBank.getBalance(), ResponseType.FAILURE,
					String.format(api.getMsg("GroupBankExists"), name));
		}

...
public class Economy_BOSE7 extends AbstractEconomy {
	...
	public EconomyResponse withdrawPlayer(String playerName, double amount) {
		if (amount < 0) {
			return new EconomyResponse(0, economy.getPlayerMoneyDouble(playerName), ResponseType.FAILURE,
	...
	public class EconomyServerListener implements Listener {
		...
		public void onPluginEnable(PluginEnableEvent event) {
			if (economy.economy == null) {
				...
				if (bose.getDescription().getName().equals("BOSEconomy")
		...
		public void onPluginDisable(PluginDisableEvent event) {
			if (economy.economy != null) {
				if (event.getPlugin().getDescription().getName().equals("BOSEconomy")
						&& event.getPlugin().getDescription().getVersion().startsWith("0.7")) {
